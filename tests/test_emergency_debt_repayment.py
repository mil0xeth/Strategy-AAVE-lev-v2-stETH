...
def test_passing_everything_should_repay_all_debt(
    ...
    strategy.emergencyDebtRepayment(strategy.estimatedTotalAssets(), {"from": vault.management()})
...
def test_passing_value_same_collat_ratio(
    ...
    strategy.emergencyDebtRepayment(totalInitial*0.2, {"from": vault.management()})
