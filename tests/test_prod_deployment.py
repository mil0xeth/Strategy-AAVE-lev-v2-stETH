...
def test_prod(
    healthCheck, productionVault, yieldBearing, token, weth, dai, strategist, token_whale, dai_whale, MarketLibClonerChoice, Strategy, wsteth_whale, wsteth,
):
    ...
    wsteth.transfer(strategy, rewards_amount*10, {'from': wsteth_whale})
    chain.sleep(1)
